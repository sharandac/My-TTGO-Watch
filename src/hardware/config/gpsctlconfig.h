 ...
 */
    ...
    class gpsctl_config_t : public BaseJsonConfig {
        ...
        bool app_control_permission = false;   /** @brief permission for apps, to control gps (on/off) */
        bool app_use_permission = false;        /** @brief permission for apps, to get gps location */
