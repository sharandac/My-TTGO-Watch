...
uint32_t tiltmouse_app_setup_tile_num;
...
void tiltmouse_app_setup( void ) {
    ...
    tiltmouse_app_setup_tile_num = tiltmouse_app_main_tile_num + 1;
 ...
 *
 */
uint32_t tiltmouse_app_get_app_setup_tile_num( void ) {
    return( tiltmouse_app_setup_tile_num );
}
