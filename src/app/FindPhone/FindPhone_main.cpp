...
void FindPhone_main_setup( uint32_t tile_num ) {
    ...
    */
	...
	lv_imgbtn_set_src(FindPhone_main_go_btn,LV_BTN_STATE_RELEASED, &eye_lid_closed);
	lv_imgbtn_set_src(FindPhone_main_go_btn,LV_BTN_STATE_PRESSED, &eye_lid_open);
	...
	iv_img_set_src (FindPhone_main_iris,&eye_iris);
