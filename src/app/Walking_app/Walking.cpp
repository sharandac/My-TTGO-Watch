...
void Walking_setup( void ) {
    ...
    //Walking_setup_tile_num = Walking_main_tile_num + 1;
    ...
    //Walking_setup_setup( Walking_setup_tile_num );
}
 ...
 *
 */
uint32_t Walking_get_app_setup_tile_num( void ) {
    return( Walking_setup_tile_num );
}
